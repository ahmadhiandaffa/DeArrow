...
export const ChannelOverridesComponent = () => {
    ...
    const [thumbnailFallbackAutogenerated, setThumbnailFallbackAutogenerated] = React.useState(getConfig(selectedConfigurationID) ? getValue(getConfig(selectedConfigurationID)!, "thumbnailFallbackAutogenerated") : "");
    ...
    React.useEffect(() => {
        ...
        setThumbnailFallbackAutogenerated(getConfig(selectedConfigurationID) ? getValue(getConfig(selectedConfigurationID)!, "thumbnailFallbackAutogenerated") : "");
        ...
        <div className="channelOverrides">
...

            {
                ...
                <>
                    ...
                    {
                        getValueWithDefault(thumbnailFallback, "thumbnailFallback") === ThumbnailFallbackOption.AutoGenerated &&
                        <SelectOptionComponent
                            id="thumbnailFallbackAutogenerated"
                            onChange={(value) => {
                                updateValue(getConfig(selectedConfigurationID)!, "thumbnailFallbackAutogenerated", parseInt(value, 10), setThumbnailFallbackAutogenerated);
                            }}
                            value={getValueWithDefault(thumbnailFallbackAutogenerated, "thumbnailFallbackAutogenerated")}
                            className={getClassNames(thumbnailFallbackAutogenerated)}
                            options={[
                            ...
                            showResetButton={shouldShowResetButton(thumbnailFallbackAutogenerated)}
                            onReset={() => {
                                updateValue(getConfig(selectedConfigurationID)!, "thumbnailFallbackAutogenerated", null, setThumbnailFallbackAutogenerated);
                            }}
                        />
                    }
